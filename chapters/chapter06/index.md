...
契約が肥大化すると、
AI と人間の双方が、必須項目と分岐条件の境界を見失います。
第6章では、積と余積を使って
契約を最小標準形へ戻します。

本章の見せ場は、悪い契約/良い契約の対比と契約テンプレです。
入力の束と結果の分岐を分けるだけで、レビュー観点がかなり整理されます。
...
4. Context Pack を更新した場合は検証を通す。
   ...
   - （任意）`npm run qa` で CI 相当の主要チェックを一括実行する。
