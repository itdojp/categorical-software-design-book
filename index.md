...
- 辞書的参照ルート（レビュー担当・運用担当向け）:
  - 用語は [用語集（Glossary）](GLOSSARY.md)、図版と症状別導線は [付録D: クイックリファレンス](appendices/desk-reference/)、テンプレは [付録A: 設計成果物テンプレ集](appendices/templates/)、プロンプトは [付録B: AIエージェント用プロンプト集](appendices/prompts/) を起点に引き直す
...
- [付録D: クイックリファレンス](appendices/desk-reference/)
...
- 図版/チェックリスト/症状別の再参照: [付録D: クイックリファレンス](appendices/desk-reference/)
- 用語/記法/図式の統一ルール:
