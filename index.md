...
| ACTの実装・研究カタログ | [付録E: Applied Category Theory 実装カタログ]({{ '/appendices/implementation-catalog/' | relative_url }}) | 付録Eと公式URL |
...
- ACTの実装・研究候補から章へ戻りたい: [付録E: Applied Category Theory 実装カタログ]({{ '/appendices/implementation-catalog/' | relative_url }}) → 第7章 / 第8章 / 第9章
...
- [付録E: Applied Category Theory 実装カタログ]({{ '/appendices/implementation-catalog/' | relative_url }})
...
- 版差確認: [コミット履歴](https://github.com/itdojp/categorical-software-design-book/commits/main/) / [PR 一覧](https://github.com/itdojp/categorical-software-design-book/pulls)
...
注記: 上の「最終更新」は公開サイトのビルド日です。公開本文と開発中の版差を確認する場合は、`CHANGELOG.md`、コミット履歴、PR 一覧を参照してください。
