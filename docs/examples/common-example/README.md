...
- 形式と必須項目の正本: [`docs/spec/context-pack-v1.md`](../../spec/context-pack-v1.md) / [`docs/spec/context-pack-v2.md`](../../spec/context-pack-v2.md)
- local 検証 / authoring 用入口: [`docs/examples/common-example/context-pack-v1.yaml`](./context-pack-v1.yaml) / [`docs/examples/common-example/context-pack-v2.yaml`](./context-pack-v2.yaml)
