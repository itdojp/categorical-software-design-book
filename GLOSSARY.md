...
効果（IO/DB/例外/再試行等）を型に押し上げ、left identity、right identity、associativityを満たす合成規則を明示する枠組み。

本書での使い方: pure core / impure shell を維持するための語彙として用い、第9章で形式law、agent runtimeへの比喩、観測可能な検証条件を分けて扱う。
